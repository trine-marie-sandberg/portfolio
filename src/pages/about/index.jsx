...
export default function About() {
    return(
        <SectionWrap>
            ...
            <h2>Hi 👋</h2>
            <p>
                My name is Trine Marie Sandberg, and I'm a front end developer.
            ...
            <p>
                Today I'm a front end development graduate, and can't wait to take on new challenges to grow my knowledge and experience. 
                I am not afraid to jump into uncharted waters, but also know when to ask for help.
            </p>
            <p>
                If you are interested, please send me a mail at trine.marie.sandberg@gmail.com
            </p>
